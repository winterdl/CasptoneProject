...
public class MediaTasks {
    ...
    public static final String ACTION_UPDATE="com.vpaliy.melophile.update";
    public static final String ACTION_START_WIDGET="com.vpaliy.melophile.start_widget";
    public static final String ACTION_STOP_WIDGET="com.vpaliy.melophile.stop_widget";
